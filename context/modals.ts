...
export const closeSearcModal = modals.createEvent()
...
.createStore(false)
.on(showSizeTable, () => true) // змінено на правильне значення
.on(closeSizeTable, () => false); // змінено на правильне значення