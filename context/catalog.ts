...
export const $colorsOptions = catalog
  .createStore<IColorOption[]>([
    { id: 1, colorCode: 'black', checked: false, colorText: '' },
    { id: 2, colorCode: 'white', checked: false, colorText: '' },
    { id: 3, colorCode: 'gray', checked: false, colorText: '' },
    { id: 4, colorCode: 'red', checked: false, colorText: '' },
    { id: 5, colorCode: 'beige', checked: false, colorText: '' },
    { id: 6, colorCode: 'brown', checked: false, colorText: '' },
    { id: 7, colorCode: 'pink', checked: false, colorText: '' },
  ])
