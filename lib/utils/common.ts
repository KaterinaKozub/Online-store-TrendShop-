...
import { closeSearcModal, closeSizeTable, showQuickViewModal, showSizeTable } from "@/context/modals"
...
export const formatPrice = (x: string | number): string => {
  const cleaned = typeof x === 'string' ? x.replace(/[^\d.]/g, '') : x.toString();
...
export const getCartItemCountBySize = (
  ...
  if (!updatedItems.length) {
    ...
    export const safeFormatPrice = (value: number): string => {
