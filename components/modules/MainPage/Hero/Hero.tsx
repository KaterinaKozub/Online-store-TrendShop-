...
import img2 from '@/public/img/white-t.png'
import img3 from '@/public/img/grey-t.png'
...
const Hero = () => {
    ...
    const slides = [
        {
          id: 1,
          title: `${translations[lang].main_page.tShirt} «Casual Base» ${translations[lang].main_page.black}`,
          image: img1,
        },
        {
          id: 2,
          title: `${translations[lang].main_page.tShirt} «Casual Base» ${translations[lang].main_page.white}`,
          image: img2,
        },
        {
          id: 3,
          title: `${translations[lang].main_page.tShirt} «Casual Base» ${translations[lang].main_page.gray}`,
          image: img3,
        },
      ]
                    ...
                    <h2 className={styles.hero__title}>
                        <span
                            className={`${styles.hero__title__subtitle} ${
                                lang === 'uk' ? '' : styles.hero__title__subtitle__lang
                            }`}
                        >
