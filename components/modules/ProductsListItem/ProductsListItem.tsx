...
const ProductsListItem = ({ item, title }: IProductsListItemProps) => {
    ...
    return (
        <>
            {item.characteristics && item.characteristics.collection === 'Casual Base' && item.type === 't-shirts' ? (
                <li className={styles.list__item_ad}>
                    ...
                    >
                        ...
                        <p className={styles.list__item_ad__title}>
                            <span>
                                {translations[lang].main_page.tShirt} «Casual Base»{' '}
                                {
                ...
                <li className={styles.list__item}>
                    {title ? (
                        <span
                            ...
                            style={{left: isTitleForNew ? 60 : 16 }}
                        >
                            {isTitleForNew
                    ...
                    <div className={styles.list__item__actions}>
                        <ProductItemActionBtn
                            ...
                            iconClass={`${
                                addToFavoritesSpinner ? 'actions__btn_spinner' :  isProductInFavorites 
